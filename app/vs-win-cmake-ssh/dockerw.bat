...
:cli-start (
    ...
    echo ^> Setting Server
    docker exec -ti complier-%PROJECT_NAME% bash -l -c "service ssh start && useradd -m -d /home/compiler -s /bin/bash -G sudo compiler && echo 'compiler:compiler1234' | chpasswd"
